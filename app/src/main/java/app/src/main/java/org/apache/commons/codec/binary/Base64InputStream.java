...
public class Base64InputStream extends BaseNCodecInputStream {
    ...
    public Base64InputStream(final InputStream in, final boolean doEncode) {
        super(in, new Base64_New(false), doEncode);
    }
    ...
    public Base64InputStream(final InputStream in, final boolean doEncode,
        ...
        super(in, new Base64_New(lineLength, lineSeparator), doEncode);
    }
    ...
    public Base64InputStream(final InputStream in, final boolean doEncode,
        ...
        super(in, new Base64_New(lineLength, lineSeparator, false, decodingPolicy), doEncode);
    }
}
