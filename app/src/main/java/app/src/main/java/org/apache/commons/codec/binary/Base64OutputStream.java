...
public class Base64OutputStream extends BaseNCodecOutputStream {
    ...
    public Base64OutputStream(final OutputStream out, final boolean doEncode) {
        super(out,new Base64_New(false), doEncode);
    }
    ...
    public Base64OutputStream(final OutputStream out, final boolean doEncode,
        ...
        super(out, new Base64_New(lineLength, lineSeparator), doEncode);
    }
    ...
    public Base64OutputStream(final OutputStream out, final boolean doEncode,
        ...
        super(out, new Base64_New(lineLength, lineSeparator, false, decodingPolicy), doEncode);
    }
}
